  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      styleEl.textContent = `
        ...
        .dswpl-po-title { font-size: 12px; font-weight: 600; }
        .dswpl-po-list { overflow-y: auto; max-height: 250px; padding: 4px; }
        .dswpl-po-item {
      ...
      function renderPopover() {
        ...
        title.textContent = s.enabled ? "壁纸已开启" : "壁纸已关闭";
